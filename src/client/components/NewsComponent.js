...
class NewsComponent extends React.Component {
    ...
    componentDidMount() {
        this.props.fetchNews(this.state.startPage, this.state.endPage);
    }

    previousPage() {
        const endPage = this.state.endPage > 61 ? this.state.endPage - 30 : 31;
        const startPage = this.state.startPage > 31 ? this.state.startPage - 30 : 1;
        console.log('previousPage...' + startPage + " --- " + endPage);
        this.setState({
            endPage: endPage,
            startPage: startPage
        })
        this.props.fetchNews(startPage, endPage);
    }

    nextPage() {
        const endPage = this.state.endPage + 30;
        const startPage = this.state.startPage + 30;
    ...
    render() {
        ...
        return (
            <div className="c-news">
                ...
                <div className="c-news__pagination">
                    <div className="c-news__pagination-btn">
                        <a href="#" className="c-news__pagination-btn--prev" onClick={this.previousPage.bind(this)}>Previous</a>
                        <a href="#" className="c-news__pagination-btn--next" onClick={this.nextPage.bind(this)}>Next</a>
                    </div>
                </div>

                <hr />
                <div className="c-news__lineChart">
...
const dispatchProps = dispatch => ({
    fetchNews: (start, end) => dispatch(fetchNews(start, end)),
